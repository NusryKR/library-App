...
public class BooksAdapter extends RecyclerView.Adapter<BooksAdapter.ProductViewHolder>{
    ...
    @Override
    public BooksAdapter.ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        View view = inflater.inflate(R.layout.book_list, null);
        return new BooksAdapter.ProductViewHolder(view);
    }

    @Override
    public void onBindViewHolder(BooksAdapter.ProductViewHolder holder, int position) {
    ...
    class ProductViewHolder extends RecyclerView.ViewHolder {
        ...
        public ProductViewHolder(View itemView) {
            super(itemView);
            cardView = itemView.findViewById(R.id.card_view_books);
